...
interior.children.create(name: "その他")
...
handmade.children.create(name: "その他")
...
ticket.children.create(name: "その他")

car_motorcycle = Category.create(name: "自動車・オートバイ")
car_motorcycle_car_body = car_motorcycle.children.create(name: "自動車本体")
car_motorcycle_car_body.children.create([{name: "国内自動車本体"},{name: "外国自動車本体"}])
car_motorcycle_tire_wheel = car_motorcycle.children.create(name: "自動車タイヤ/ホイール")
car_motorcycle_tire_wheel.children.create([{name: "タイヤ/ホイールセット"},{name: "タイヤ"},{name: "ホイール"},{name: "その他"}])
car_motorcycle_car_parts = car_motorcycle.children.create(name: "自動車パーツ")
car_motorcycle_car_parts.children.create([{name: "サスペンション"},{name: "ブレーキ"},{name: "外装、エアロパーツ"},{name: "ライト"},{name: "内装品、シート"},{name: "ステアリング"},{name: "マフラー・排気系"},{name: "エンジン、過給器、冷却装置"},{name: "クラッチ、ミッション、駆動系"},{name: "電装品"},{name: "補強パーツ"},{name: "汎用パーツ"},{name: "外国自動車用パーツ"},{name: "その他"}])
car_motorcycle_car_accessory = car_motorcycle.children.create(name: "自動車アクセサリー")
car_motorcycle_car_accessory.children.create([{name: "車内アクセサリー"},{name: "カーナビ"},{name: "カーオーディオ"},{name: "車外アクセサリー"},{name: "メンテナンス用品"},{name: "チャイルドシート"},{name: "ドライブレコーダー"},{name: "レーダー探知機"},{name: "カタログ/マニュアル"},{name: "セキュリティ"},{name: "ETC"},{name: "その他"}])
car_motorcycle.children.create(name: "オートバイ車体")
car_motorcycle_motorcycle_parts = car_motorcycle.children.create(name: "オートバイパーツ")
car_motorcycle_motorcycle_parts.children.create([{name: "タイヤ"},{name: "マフラー"},{name: "エンジン、冷却装置"},{name: "カウル、フェンダー、外装"},{name: "サスペンション"},{name: "ホイール"},{name: "シート"},{name: "ブレーキ"},{name: "タンク"},{name: "ライト、ウィンカー"},{name: "チェーン、スプロケット、駆動系"},{name: "メーター"},{name: "電装系"},{name: "ミラー"},{name: "外国オートバイ用パーツ"},{name: "その他"}])
car_motorcycle_motorcycle_accessory = car_motorcycle.children.create(name: "オートバイアクセサリー")
car_motorcycle_motorcycle_accessory.children.create([{name: "ヘルメット/シールド"},{name: "バイクウエア/装備"},{name: "アクセサリー"},{name: "メンテナンス"},{name: "カタログ/マニュアル"},{name: "その他"}])

others = Category.create(name: "その他")
others.children.create(name: "まとめ売り")
others_pet_supplies = others.children.create(name: "ペット用品")
others_pet_supplies.children.create([{name: "ペットフード"},{name: "犬用品"},{name: "猫用品"},{name: "魚用品/水草"},{name: "小動物用品"},{name: "爬虫類/両生類用品"},{name: "かご/おり"},{name: "鳥用品"},{name: "虫類用品"},{name: "その他"}])
...
others_beverage = others.children.create(name: "飲料/酒")
others_beverage.children.create([{name: "コーヒー"},{name: "ソフトドリンク"},{name: "ミネラルウォーター"},{name: "茶"},{name: "ウイスキー"},{name: "ワイン"},{name: "ブランデー"},{name: "焼酎"},{name: "日本酒"},{name: "ビール、発泡酒"},{name: "その他"}])
others_commodity = others.children.create(name: "日用品/生活雑貨/旅行")
others_commodity.children.create([{name: "タオル/バス用品"},{name: "日用品/生活雑貨"},{name: "洗剤/柔軟剤"},{name: "旅行用品"},{name: "防災関連グッズ"},{name: "その他"}])
...
others_office_supplies = others.children.create(name: "事務/店舗用品")
others_office_supplies.children.create([{name: "オフィス用品一般"},{name: "オフィス家具"},{name: "店舗用品"},{name: "OA機器"},{name: "ラッピング/包装"},{name: "その他"}])
others.children.create(name: "その他")
